...
aimingtest.inGame.prototype = {
        ...
        this.input.onDown.add(function (pointerPosition) {
            ...
            if (!t.reloadTime) {
                ...
                if (isHit && distance < 70) {
                    ...
                    if (this.shotsCounter == 10) {
                        this.showResults();
                        return;
                    };
                    setTimeout(t.resetTarget.bind(t), this.math.between(800, 1500));
    ...
    setTimer: function () {
        this.targetTimer = setTimeout(this.resetTarget.bind(this), 1000);
    },
    ...
    showResults: function () {
        ...
        // Total score
        var totalScore = this.score + this.bonusDistanceCounter * this.pointsDistanceBonus + this.bonusTimeCounter * this.pointsTimeBonus - this.failedShotsCounter * 400;
        var row = document.createElement('tr');
        ...
        cell.textContent = totalScore.toString();
        row.appendChild(cell);
        tableResults.appendChild(row);
